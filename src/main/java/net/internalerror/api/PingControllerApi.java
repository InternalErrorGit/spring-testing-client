...
public class PingControllerApi {
     ...
     */
    public okhttp3.Call pongCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call pongValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return pongCall(_callback);
     ...
     */
    public String pong() throws ApiException {
        ApiResponse<String> localVarResp = pongWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> pongWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = pongValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call pongAsync(final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = pongValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
